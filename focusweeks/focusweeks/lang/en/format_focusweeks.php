...
$string['page-course-view-focusweeks'] = 'Any course main page in weekly sections format';
$string['page-course-view-focusweeks-x'] = 'Any course page in weekly sections format';
$string['pluginname'] = 'Focusweeks';
...
$string['pluginname'] = 'Focus weeks';
$string['weekoffset'] = 'Week offset';
$string['weekoffset_help'] = 'Shifts which week is considered "current". 
For example, an offset of 2 makes the current week show 2 weeks later in the course order.';
